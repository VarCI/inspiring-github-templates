...
#### .github/ISSUE_TEMPLATE.md
<pre lang="no-highlight"><code><!-- Please only file bugs with Foundation on GitHub. If you've got a more general question about how to use Foundation, we can help you on the Foundation Forum: http://foundation.zurb.com/forum -->
...
### <img src="http://www.google.com/s2/favicons?domain=http://square.github.io/okhttp/" width="16" height="16" />&nbsp;[square/okhttp](https://github.com/square/okhttp)
...
#### PULL_REQUEST_TEMPLATE.md
<pre lang="no-highlight"><code><!-- Make sure you've run `gradlew clean check jar assemble` before commit. -->
...
<!-- If you have any issues feel free to create the PR anyway, we'll help to resolve them. --></code></pre>
...
#### .github/ISSUE_TEMPLATE.md
<pre lang="no-highlight"><code><!--- Verify first that your issue/request is not already reported in GitHub -->
...
### <img src="http://www.google.com/s2/favicons?domain=https://getcomposer.org/" width="16" height="16" />&nbsp;[composer/composer](https://github.com/composer/composer)
...
#### .github/PULL_REQUEST_TEMPLATE.md
<pre lang="no-highlight"><code><!-- Please complete this template before creating pull request. -->
...
### <img src="http://www.google.com/s2/favicons?domain=http://tensorflow.org" width="16" height="16" />&nbsp;[tensorflow/tensorflow](https://github.com/tensorflow/tensorflow)
...
### <img src="http://www.google.com/s2/favicons?domain=opencv.org" width="16" height="16" />&nbsp;[Itseez/opencv](https://github.com/Itseez/opencv)
...
#### .github/PULL_REQUEST_TEMPLATE.md
<pre lang="no-highlight"><code><!-- You can remove this first section if you have contributed before -->
...
### <img src="http://www.google.com/s2/favicons?domain=https://gitbucket.github.io/gitbucket-news/" width="16" height="16" />&nbsp;[gitbucket/gitbucket](https://github.com/gitbucket/gitbucket)


#### .github/ISSUE_TEMPLATE.md
<pre lang="no-highlight"><code>### Before submitting an issue to Gitbucket I have first:
...
#### .github/PULL_REQUEST_TEMPLATE.md
<pre lang="no-highlight"><code>### Before submitting a pull-request to Gitbucket I have first:
...
### <img src="http://www.google.com/s2/favicons?domain=http://twitter.github.io/finagle" width="16" height="16" />&nbsp;[twitter/finagle](https://github.com/twitter/finagle)


#### .github/PULL_REQUEST_TEMPLATE.md
<pre lang="no-highlight"><code>Problem
...
### <img src="http://www.google.com/s2/favicons?domain=http://scala-sbt.org" width="16" height="16" />&nbsp;[sbt/sbt](https://github.com/sbt/sbt)


#### ISSUE_TEMPLATE.md
<pre lang="no-highlight"><code>(See the guidelines for contributing, linked above)
...
## Lua
### <img src="http://www.google.com/s2/favicons?domain=http://cmusatyalab.github.io/openface/" width="16" height="16" />&nbsp;[cmusatyalab/openface](https://github.com/cmusatyalab/openface)


#### .github/ISSUE_TEMPLATE.md
<pre lang="no-highlight"><code><!-- The GitHub issue tracker is for development discussions and bug tracking.
...
#### .github/ISSUE_TEMPLATE.md
<pre lang="no-highlight"><code>#### Describe the issue
...
## Clojure
### <img src="http://www.google.com/s2/favicons?domain=http://metabase.com" width="16" height="16" />&nbsp;[metabase/metabase](https://github.com/metabase/metabase)


#### ISSUE_TEMPLATE.md
<pre lang="no-highlight"><code>If this is a bug report, please fill in the blanks:
...
#### PULL_REQUEST_TEMPLATE.md
<pre lang="no-highlight"><code>Before we can merge your pull request, you'll need to sign our [Contributor License Agreement](https://docs.google.com/a/metabase.com/forms/d/1oV38o7b9ONFSwuzwmERRMi9SYrhYeOrkbmNaq9pOJ_E/viewform)
...
## Groovy
### <img src="http://www.google.com/s2/favicons?domain=http://springfox.io" width="16" height="16" />&nbsp;[springfox/springfox](https://github.com/springfox/springfox)


#### .github/ISSUE_TEMPLATE.md
<pre lang="no-highlight"><code>Please take the time to search the repository, if your question has already been asked or answered.
...
What kind of issue is this?
 ...
 - [ ] Feature Request. Start by telling us what problem you’re trying to solve. Often a solution
       already exists! Don’t send pull requests to implement new features without first getting our
       support. Sometimes we leave features out on purpose to keep the project small.</code></pre>



#### .github/PULL_REQUEST_TEMPLATE.md
<pre lang="no-highlight"><code>#### What's this PR do/fix?
#### Are there unit tests? If not how should this be manually tested?
#### Any background context you want to provide?
#### What are the relevant issues?
</code></pre>

### [groovy/groovy-android-gradle-plugin](https://github.com/groovy/groovy-android-gradle-plugin)
...
## PowerShell
### <img src="http://www.google.com/s2/favicons?domain=https://chocolatey.org" width="16" height="16" />&nbsp;[chocolatey/chocolatey](https://github.com/chocolatey/chocolatey)
...
### <img src="http://www.google.com/s2/favicons?domain=http://www.powershellempire.com/" width="16" height="16" />&nbsp;[PowerShellEmpire/Empire](https://github.com/PowerShellEmpire/Empire)


#### .github/ISSUE_TEMPLATE.md
<pre lang="no-highlight"><code>## Empire Version
